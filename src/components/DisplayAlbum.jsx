        ...
        <>
            ...
            <div className='mt-10 flex gap-8 flex-col md:flex-row md:items-end'>
                ...
                <div className='flex flex-col'>
                    ...
                    <p className='mt-1'>
                        ...
                        | 1,323,154 likes
                        <b className='mr-2 ml-2'>50 songs</b>
                        about 2hr 30min
                    </p>
                </div>
            </div>
            <div className='grid grid-cols-3 sm:grid-cols-4 mt-10 pl-2 text-[#a7a7a7]'>
                <p className='ml-5'><b className='mr-4'>#</b>Title</p>
                <p>Album</p>
            ...
            <hr />
            {
                songsData.map((item, index) => (
                    <div onClick={() => playWithId(item.id)} key={index} className='grid grid-cols-3 sm:grid-cols-4 gap-2 p-2 items-center text-[#a7a7a7] hover:bg-[#ffffff2b] cusor-pointer'>
